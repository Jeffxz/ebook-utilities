...
const EpubErrorType = {
    ...
    ERR_EPUB_OPF_SPINE_ITEMREF_NO_IDREF: -2015,

    ERR_EPUB_OPF_NO_PACKAGE: -2016,
    ERR_EPUB_OPF_PACKAGE_NO_VERSION: -2017,
    ERR_EPUB_OPF_PACKAGE_NO_UNIUE_ID: -2018,
    ERR_EPUB_OPF_PACKAGE_METADATA_COUNT: -2019,
    ERR_EPUB_OPF_PACKAGE_MANIFEST_COUNT: -2020,
    ERR_EPUB_OPF_PACKAGE_SPINE_COUNT: -2021
}
